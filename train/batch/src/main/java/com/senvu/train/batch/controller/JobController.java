package com.senvu.train.batch.controller;

import com.senvu.result.Result;
import com.senvu.train.batch.req.CronJobReq;
import com.senvu.train.batch.resp.CronJobResp;
import org.quartz.*;
...
public class JobController {
    ...
    public Result<Object> run(@RequestBody CronJobReq cronJobReq) throws SchedulerException {
        ...
        return new Result<>(Result.SUCCESS_CODE,"手动执行成功");
    }
    ...
    public Result add(@RequestBody CronJobReq cronJobReq) {
        ...
        commonResp.setCode(Result.SUCCESS_CODE);
        return commonResp;
    }
