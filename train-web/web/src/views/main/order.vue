<template>
  ...
  <a-modal v-model:visible="firstImageCodeModalVisible" :title="null" :footer="null" :closable="false"
    ...
    <a-button type="danger" block @click="handleOk">提交验证码</a-button>
  </a-modal>
...
import SESSION_ORDER from '@/utils/session-storage';
// import SESSION_TICKET_PARAMS from '@/utils/session-storage';
